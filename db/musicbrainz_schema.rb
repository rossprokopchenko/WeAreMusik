...
ActiveRecord::Schema[8.0].define(version: 2025_07_04_133137) do
  ...
  create_table "canonical_musicbrainz_data", force: :cascade do |t|
    ...
    t.integer "score"
    t.index "((release_mbid)::uuid)", name: "idx_canonical_musicbrainz_data_release_mbid_uuid"
  end

  create_table "canonical_recording_redirect", id: false, force: :cascade do |t|
    t.text "recording_mbid"
    t.text "canonical_recording_mbid"
    t.text "canonical_release_mbid"
  end

  create_table "canonical_release_redirect", id: false, force: :cascade do |t|
    t.text "release_mbid"
    t.text "canonical_release_mbid"
  ...
  create_table "medium", id: :serial, force: :cascade do |t|
    ...
    t.index ["release"], name: "index_medium_on_release"
...
#   Unknown type 'cube' for column 'toc'
  ...
  create_table "release", id: :serial, force: :cascade do |t|
    ...
    t.index ["gid"], name: "index_release_on_gid", unique: true
  ...
  create_table "track", id: :serial, force: :cascade do |t|
    ...
    t.index ["is_canonical", "id"], name: "index_track_on_is_canonical_and_id"
    t.index ["is_canonical"], name: "index_track_on_is_canonical"
    t.index ["medium"], name: "index_track_on_medium"
