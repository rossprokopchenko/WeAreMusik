...
ActiveRecord::Schema[8.0].define(version: 2025_06_17_171852) do
  ...
  enable_extension "public.cube"
  enable_extension "public.earthdistance"
  ...
  create_table "area", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "area_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
    t.check_constraint "edits_pending >= 0", name: "area_edits_pending_check"
    t.check_constraint "name::text <> ''::text", name: "only_non_empty"
  end
  ...
  create_table "area_alias", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
    t.check_constraint "controlled_for_whitespace(sort_name::text)", name: "control_for_whitespace_sort_name"
    ...
    t.check_constraint "name::text <> ''::text", name: "only_non_empty"
    t.check_constraint "sort_name::text <> ''::text", name: "only_non_empty_sort_name"
  end
  ...
  create_table "area_containment", primary_key: ["descendant", "parent"], force: :cascade do |t|
    t.integer "descendant", null: false
    t.integer "parent", null: false
    t.integer "depth", limit: 2, null: false
    t.index ["parent"], name: "area_containment_idx_parent"
  end
  ...
  create_table "artist", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "artist_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
    t.check_constraint "controlled_for_whitespace(sort_name::text)", name: "control_for_whitespace_sort_name"
    t.check_constraint "edits_pending >= 0", name: "artist_edits_pending_check"
    t.check_constraint "gender IS NULL AND (type = ANY (ARRAY[2, 5, 6])) OR (type <> ALL (ARRAY[2, 5, 6])) OR type IS NULL", name: "group_type_implies_null_gender"
    t.check_constraint "id <> 1 OR type = 3 AND gender IS NULL AND area IS NULL AND begin_area IS NULL AND end_area IS NULL AND begin_date_year IS NULL AND begin_date_month IS NULL AND begin_date_day IS NULL AND end_date_year IS NULL AND end_date_month IS NULL AND end_date_day IS NULL", name: "artist_va_check"
    t.check_constraint "name::text <> ''::text", name: "only_non_empty"
    t.check_constraint "sort_name::text <> ''::text", name: "only_non_empty_sort_name"
  end
  ...
  create_table "artist_alias", id: :serial, force: :cascade do |t|
    ...
    t.boolean "primary_for_locale", default: false, null: false
    t.boolean "ended", default: false, null: false
    t.index "lower(musicbrainz_unaccent((name)::text))", name: "artist_alias_idx_lower_unaccent_name"
  ...
  create_table "artist_credit", id: :serial, force: :cascade do |t|
    ...
    t.index ["gid"], name: "artist_credit_idx_gid", unique: true
  ...
  create_table "artist_credit_gid_redirect", primary_key: "gid", id: :uuid, default: nil, force: :cascade do |t|
    t.integer "new_id", null: false
    t.timestamptz "created", default: -> { "now()" }
    t.index ["new_id"], name: "artist_credit_gid_redirect_idx_new_id"
  end
  ...
  create_table "artist_release", id: false, options: "PARTITION BY LIST (is_track_artist)", force: :cascade do |t|
    t.boolean "is_track_artist", null: false
    t.integer "artist", null: false
    t.integer "first_release_date"
    t.text "catalog_numbers", array: true
    t.string "country_code", limit: 2
    t.bigint "barcode"
    t.string "name", null: false, collation: "musicbrainz"
    t.integer "release", null: false
  end

  create_table "artist_release_group", id: false, options: "PARTITION BY LIST (is_track_artist)", force: :cascade do |t|
    t.boolean "is_track_artist", null: false
    t.integer "artist", null: false
    t.boolean "unofficial", null: false
    t.integer "primary_type_child_order", limit: 2
    t.integer "primary_type", limit: 2
    t.integer "secondary_type_child_orders", limit: 2, array: true
    t.integer "secondary_types", limit: 2, array: true
    t.integer "first_release_date"
    t.string "name", null: false, collation: "musicbrainz"
    t.integer "release_group", null: false
  end

  create_table "artist_release_group_nonva", id: false, options: "INHERITS (artist_release_group)", force: :cascade do |t|
    t.boolean "is_track_artist", null: false
    t.integer "artist", null: false
    t.boolean "unofficial", null: false
    t.integer "primary_type_child_order", limit: 2
    ...
    t.string "name", null: false, collation: "musicbrainz"
    t.integer "release_group", null: false
    t.index ["artist", "unofficial", "primary_type_child_order", "primary_type", "secondary_type_child_orders", "secondary_types", "first_release_date", "name", "release_group"], name: "artist_release_group_nonva_idx_sort", order: { primary_type_child_order: "NULLS FIRST", primary_type: "NULLS FIRST", secondary_type_child_orders: "NULLS FIRST", secondary_types: "NULLS FIRST" }
    t.index ["release_group", "artist"], name: "artist_release_group_nonva_idx_uniq", unique: true
  end

  create_table "artist_release_group_pending_update", id: false, force: :cascade do |t|
    t.integer "release_group", null: false
    t.index ["release_group"], name: "artist_release_group_pending_update_idx_release_group", using: :hash
  end

  create_table "artist_release_group_va", id: false, options: "INHERITS (artist_release_group)", force: :cascade do |t|
    t.boolean "is_track_artist", null: false
    t.integer "artist", null: false
    t.boolean "unofficial", null: false
    t.integer "primary_type_child_order", limit: 2
    ...
    t.string "name", null: false, collation: "musicbrainz"
    t.integer "release_group", null: false
    t.index ["artist", "unofficial", "primary_type_child_order", "primary_type", "secondary_type_child_orders", "secondary_types", "first_release_date", "name", "release_group"], name: "artist_release_group_va_idx_sort", order: { primary_type_child_order: "NULLS FIRST", primary_type: "NULLS FIRST", secondary_type_child_orders: "NULLS FIRST", secondary_types: "NULLS FIRST" }
    t.index ["release_group", "artist"], name: "artist_release_group_va_idx_uniq", unique: true
  end

  create_table "artist_release_nonva", id: false, options: "INHERITS (artist_release)", force: :cascade do |t|
    t.boolean "is_track_artist", null: false
    t.integer "artist", null: false
    t.integer "first_release_date"
    t.text "catalog_numbers", array: true
    ...
    t.string "name", null: false, collation: "musicbrainz"
    t.integer "release", null: false
    t.index ["artist", "first_release_date", "catalog_numbers", "country_code", "barcode", "name", "release"], name: "artist_release_nonva_idx_sort"
    t.index ["release", "artist"], name: "artist_release_nonva_idx_uniq", unique: true
  end

  create_table "artist_release_pending_update", id: false, force: :cascade do |t|
    t.integer "release", null: false
    t.index ["release"], name: "artist_release_pending_update_idx_release", using: :hash
  end

  create_table "artist_release_va", id: false, options: "INHERITS (artist_release)", force: :cascade do |t|
    t.boolean "is_track_artist", null: false
    t.integer "artist", null: false
    t.integer "first_release_date"
    t.text "catalog_numbers", array: true
    ...
    t.string "name", null: false, collation: "musicbrainz"
    t.integer "release", null: false
    t.index ["artist", "first_release_date", "catalog_numbers", "country_code", "barcode", "name", "release"], name: "artist_release_va_idx_sort"
    t.index ["release", "artist"], name: "artist_release_va_idx_uniq", unique: true
  end
  ...
  create_table "autoeditor_election", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "propose_time", default: -> { "now()" }, null: false
    t.timestamptz "open_time"
    t.timestamptz "close_time"
  ...
  create_table "autoeditor_election_vote", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "vote_time", default: -> { "now()" }, null: false
    t.check_constraint "vote = ANY (ARRAY['-1'::integer, 0, 1])", name: "autoeditor_election_vote_vote_check"
  end

  create_table "canonical_musicbrainz_data", id: :integer, default: nil, force: :cascade do |t|
    t.integer "artist_credit_id", null: false
    t.text "artist_mbids", null: false
    t.text "artist_credit_name", null: false
    t.text "release_mbid", null: false
    t.text "release_name", null: false
    t.text "recording_mbid", null: false
    t.text "recording_name", null: false
    t.text "combined_lookup", null: false
    t.integer "score", null: false
    t.index ["combined_lookup"], name: "idx_canonical_musicbrainz_data_combined_lookup"
    t.index ["recording_mbid"], name: "idx_canonical_musicbrainz_data_recording_mbid"
  end

  create_table "canonical_recording_redirect", primary_key: "recording_mbid", id: :text, force: :cascade do |t|
    t.text "canonical_recording_mbid", null: false
    t.text "canonical_release_mbid"
    t.index ["canonical_recording_mbid"], name: "idx_canonical_recording_redirect_canonical"
  end

  create_table "canonical_release_redirect", primary_key: "release_mbid", id: :text, force: :cascade do |t|
    t.text "canonical_release_mbid", null: false
    t.text "release_group_mbid"
    t.index ["canonical_release_mbid"], name: "idx_canonical_release_redirect_canonical"
  end
  ...
  create_table "deleted_entity", primary_key: "gid", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.timestamptz "deleted_at", default: -> { "now()" }, null: false
  end
  ...
  create_table "edit", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "open_time", default: -> { "now()" }
    t.timestamptz "close_time"
    t.timestamptz "expire_time", null: false
    t.integer "language"
  ...
  create_table "edit_data", primary_key: "edit", id: :integer, default: nil, force: :cascade do |t|
    t.jsonb "data", null: false
    t.index "array_remove(ARRAY[((data #>> '{link_type,id}'::text[]))::integer, ((data #>> '{link,link_type,id}'::text[]))::integer, ((data #>> '{old,link_type,id}'::text[]))::integer, ((data #>> '{new,link_type,id}'::text[]))::integer, ((data #>> '{relationship,link,type,id}'::text[]))::integer], NULL::integer)", name: "edit_data_idx_link_type", using: :gin
  end
  ...
  create_table "edit_genre", primary_key: ["edit", "genre"], force: :cascade do |t|
    t.integer "edit", null: false
    t.integer "genre", null: false
    t.index ["genre"], name: "edit_genre_idx"
  end
  ...
  create_table "edit_mood", primary_key: ["edit", "mood"], force: :cascade do |t|
    t.integer "edit", null: false
    t.integer "mood", null: false
    t.index ["mood"], name: "edit_mood_idx"
  end
  ...
  create_table "edit_note", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "post_time", default: -> { "now()" }
    t.index ["edit"], name: "edit_note_idx_edit"
    t.index ["editor"], name: "edit_note_idx_editor"
  end

  create_table "edit_note_change", id: :serial, force: :cascade do |t|
    t.enum "status", enum_type: "edit_note_status"
    t.integer "edit_note", null: false
    t.integer "change_editor", null: false
    t.timestamptz "change_time", default: -> { "now()" }
    t.text "old_note", null: false
    t.text "new_note", null: false
    t.text "reason", default: "", null: false
    t.index ["edit_note"], name: "edit_note_change_idx_edit_note"
  end
  ...
  create_table "editor", id: :serial, force: :cascade do |t|
    ...
    t.text "bio"
    t.timestamptz "member_since", default: -> { "now()" }
    t.timestamptz "email_confirm_date"
    t.timestamptz "last_login_date", default: -> { "now()" }
    t.timestamptz "last_updated", default: -> { "now()" }
    t.date "birth_date"
    t.integer "gender"
    t.integer "area"
  ...
  create_table "editor_collection_area", primary_key: ["collection", "area"], force: :cascade do |t|
    ...
    t.integer "area", null: false
    t.timestamptz "added", default: -> { "now()" }
  ...
  create_table "editor_collection_genre", primary_key: ["collection", "genre"], force: :cascade do |t|
    t.integer "collection", null: false
    t.integer "genre", null: false
    t.timestamptz "added", default: -> { "now()" }
    t.integer "position", default: 0, null: false
    t.text "comment", default: "", null: false
    t.check_constraint "\"position\" >= 0", name: "editor_collection_genre_position_check"
  end

  create_table "editor_collection_gid_redirect", primary_key: "gid", id: :uuid, default: nil, force: :cascade do |t|
    t.integer "new_id", null: false
    t.timestamptz "created", default: -> { "now()" }
    t.index ["new_id"], name: "editor_collection_gid_redirect_idx_new_id"
  end
  ...
  create_table "editor_language", primary_key: ["editor", "language"], force: :cascade do |t|
    t.integer "editor", null: false
    t.integer "language", null: false
    t.enum "fluency", null: false, enum_type: "fluency"
  ...
  create_table "editor_oauth_token", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "granted", default: -> { "now()" }, null: false
    t.text "code_challenge"
    t.enum "code_challenge_method", enum_type: "oauth_code_challenge_method"
  ...
  create_table "event", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "event_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "event_meta", id: :integer, default: nil, force: :cascade do |t|
    t.integer "rating", limit: 2
    t.integer "rating_count"
    t.enum "event_art_presence", default: "absent", null: false, enum_type: "event_art_presence"
  ...
  create_table "genre_alias", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "(end_date_year IS NOT NULL OR end_date_month IS NOT NULL OR end_date_day IS NOT NULL) AND ended = true OR end_date_year IS NULL AND end_date_month IS NULL AND end_date_day IS NULL", name: "genre_alias_check"
    t.check_constraint "edits_pending >= 0", name: "genre_alias_edits_pending_check"
    t.check_constraint "locale IS NULL AND primary_for_locale IS FALSE OR locale IS NOT NULL", name: "primary_check"
    t.check_constraint "type <> 2 OR type = 2 AND sort_name::text = name::text AND begin_date_year IS NULL AND begin_date_month IS NULL AND begin_date_day IS NULL AND end_date_year IS NULL AND end_date_month IS NULL AND end_date_day IS NULL AND primary_for_locale IS FALSE AND locale IS NULL", name: "search_hints_are_empty"
  end

  create_table "genre_alias_type", id: :serial, force: :cascade do |t|
    t.text "name", null: false
    t.integer "parent"
    t.integer "child_order", default: 0, null: false
    t.text "description"
    t.uuid "gid", null: false
    t.index ["gid"], name: "genre_alias_type_idx_gid", unique: true
  end

  create_table "genre_annotation", primary_key: ["genre", "annotation"], force: :cascade do |t|
    t.integer "genre", null: false
    t.integer "annotation", null: false
  end
  ...
  create_table "instrument", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "instrument_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "l_area_area", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_area_area_edits_pending_check"
    t.check_constraint "entity0 <> entity1", name: "non_loop_relationship"
  ...
  create_table "l_area_genre", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_area_genre_idx_uniq", unique: true
    t.index ["entity1"], name: "l_area_genre_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_area_genre_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_area_genre_link_order_check"
  end
  ...
  create_table "l_area_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_area_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_area_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_area_mood_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_area_mood_link_order_check"
  end
  ...
  create_table "l_artist_genre", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_artist_genre_idx_uniq", unique: true
    t.index ["entity1"], name: "l_artist_genre_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_artist_genre_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_artist_genre_link_order_check"
  end
  ...
  create_table "l_artist_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_artist_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_artist_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_artist_mood_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_artist_mood_link_order_check"
  end
  ...
  create_table "l_event_genre", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_event_genre_idx_uniq", unique: true
    t.index ["entity1"], name: "l_event_genre_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_event_genre_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_event_genre_link_order_check"
  end
  ...
  create_table "l_event_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_event_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_event_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_event_mood_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_event_mood_link_order_check"
  end
  ...
  create_table "l_genre_genre", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_genre_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_genre_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_genre_edits_pending_check"
    t.check_constraint "entity0 <> entity1", name: "non_loop_relationship"
    t.check_constraint "link_order >= 0", name: "l_genre_genre_link_order_check"
  end

  create_table "l_genre_instrument", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_instrument_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_instrument_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_instrument_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_instrument_link_order_check"
  end

  create_table "l_genre_label", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_label_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_label_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_label_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_label_link_order_check"
  end

  create_table "l_genre_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_mood_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_mood_link_order_check"
  end

  create_table "l_genre_place", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_place_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_place_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_place_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_place_link_order_check"
  end

  create_table "l_genre_recording", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_recording_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_recording_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_recording_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_recording_link_order_check"
  end

  create_table "l_genre_release", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_release_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_release_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_release_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_release_link_order_check"
  end

  create_table "l_genre_release_group", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_release_group_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_release_group_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_release_group_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_release_group_link_order_check"
  end

  create_table "l_genre_series", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_series_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_series_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_series_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_series_link_order_check"
  end

  create_table "l_genre_url", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_url_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_url_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_url_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_url_link_order_check"
  end

  create_table "l_genre_work", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_genre_work_idx_uniq", unique: true
    t.index ["entity1"], name: "l_genre_work_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_genre_work_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_genre_work_link_order_check"
  end
  ...
  create_table "l_instrument_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_instrument_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_instrument_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_instrument_mood_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_instrument_mood_link_order_check"
  end
  ...
  create_table "l_label_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_label_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_label_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_label_mood_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_label_mood_link_order_check"
  end
  ...
  create_table "l_mood_mood", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_mood_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_mood_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_mood_edits_pending_check"
    t.check_constraint "entity0 <> entity1", name: "non_loop_relationship"
    t.check_constraint "link_order >= 0", name: "l_mood_mood_link_order_check"
  end

  create_table "l_mood_place", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_place_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_place_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_place_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_place_link_order_check"
  end

  create_table "l_mood_recording", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_recording_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_recording_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_recording_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_recording_link_order_check"
  end

  create_table "l_mood_release", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_release_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_release_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_release_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_release_link_order_check"
  end

  create_table "l_mood_release_group", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_release_group_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_release_group_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_release_group_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_release_group_link_order_check"
  end

  create_table "l_mood_series", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_series_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_series_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_series_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_series_link_order_check"
  end

  create_table "l_mood_url", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_url_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_url_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_url_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_url_link_order_check"
  end

  create_table "l_mood_work", id: :serial, force: :cascade do |t|
    t.integer "link", null: false
    t.integer "entity0", null: false
    t.integer "entity1", null: false
    t.integer "edits_pending", default: 0, null: false
    ...
    t.text "entity0_credit", default: "", null: false
    t.text "entity1_credit", default: "", null: false
    t.index ["entity0", "entity1", "link", "link_order"], name: "l_mood_work_idx_uniq", unique: true
    t.index ["entity1"], name: "l_mood_work_idx_entity1"
    t.check_constraint "controlled_for_whitespace(entity0_credit)", name: "control_for_whitespace_entity0_credit"
    t.check_constraint "controlled_for_whitespace(entity1_credit)", name: "control_for_whitespace_entity1_credit"
    t.check_constraint "edits_pending >= 0", name: "l_mood_work_edits_pending_check"
    t.check_constraint "link_order >= 0", name: "l_mood_work_link_order_check"
  end
  ...
  create_table "label", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "last_updated", default: -> { "now()" }
    t.boolean "ended", default: false, null: false
    t.index "lower(musicbrainz_unaccent((name)::text)), lower(musicbrainz_unaccent((comment)::text))", name: "label_idx_lower_unaccent_name_comment"
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "label_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
    t.check_constraint "edits_pending >= 0", name: "label_edits_pending_check"
    t.check_constraint "label_code > 0 AND label_code < 1000000", name: "label_code_length"
    t.check_constraint "name::text <> ''::text", name: "only_non_empty"
  end
  ...
  create_table "label_alias", id: :serial, force: :cascade do |t|
    ...
    t.boolean "primary_for_locale", default: false, null: false
    t.boolean "ended", default: false, null: false
    t.index "lower(musicbrainz_unaccent((name)::text))", name: "label_alias_idx_lower_unaccent_name"
  ...
  create_table "language", id: :serial, force: :cascade do |t|
    ...
    t.integer "frequency", limit: 2, default: 0, null: false
  ...
  create_table "link_attribute_text_value", primary_key: ["link", "attribute_type"], force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(text_value)", name: "control_for_whitespace"
    t.check_constraint "text_value <> ''::text", name: "only_non_empty"
  end
  ...
  create_table "link_type", id: :serial, force: :cascade do |t|
    ...
    t.integer "entity0_cardinality", limit: 2, default: 0, null: false
    t.integer "entity1_cardinality", limit: 2, default: 0, null: false
  ...
  create_table "medium", id: :serial, force: :cascade do |t|
    ...
    t.uuid "gid", null: false
    t.index ["gid"], name: "medium_idx_gid", unique: true
    t.index ["track_count"], name: "medium_idx_track_count"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "medium_name_check"
    t.check_constraint "edits_pending >= 0", name: "medium_edits_pending_check"
    t.unique_constraint ["release", "position"], deferrable: :immediate, name: "medium_uniq"
  end
  ...
  create_table "medium_gid_redirect", primary_key: "gid", id: :uuid, default: nil, force: :cascade do |t|
    t.integer "new_id", null: false
    t.timestamptz "created", default: -> { "now()" }
    t.index ["new_id"], name: "medium_gid_redirect_idx_new_id"
  end
...
#   Unknown type 'cube' for column 'toc'
  ...
  create_table "mood", id: :serial, force: :cascade do |t|
    t.uuid "gid", null: false
    t.string "name", null: false
    t.string "comment", limit: 255, default: "", null: false
    t.integer "edits_pending", default: 0, null: false
    t.timestamptz "last_updated", default: -> { "now()" }
    t.index "lower((name)::text)", name: "mood_idx_name", unique: true
    t.index ["gid"], name: "mood_idx_gid", unique: true
    t.check_constraint "edits_pending >= 0", name: "mood_edits_pending_check"
  end

  create_table "mood_alias", id: :serial, force: :cascade do |t|
    t.integer "mood", null: false
    t.string "name", null: false
    t.text "locale"
    t.integer "edits_pending", default: 0, null: false
    ...
    t.boolean "primary_for_locale", default: false, null: false
    t.boolean "ended", default: false, null: false
    t.index ["mood", "locale"], name: "mood_alias_idx_primary", unique: true, where: "((primary_for_locale = true) AND (locale IS NOT NULL))"
    t.index ["mood"], name: "mood_alias_idx_mood"
    t.check_constraint "(end_date_year IS NOT NULL OR end_date_month IS NOT NULL OR end_date_day IS NOT NULL) AND ended = true OR end_date_year IS NULL AND end_date_month IS NULL AND end_date_day IS NULL", name: "mood_alias_check"
    t.check_constraint "edits_pending >= 0", name: "mood_alias_edits_pending_check"
    t.check_constraint "locale IS NULL AND primary_for_locale IS FALSE OR locale IS NOT NULL", name: "primary_check"
    t.check_constraint "type <> 2 OR type = 2 AND sort_name::text = name::text AND begin_date_year IS NULL AND begin_date_month IS NULL AND begin_date_day IS NULL AND end_date_year IS NULL AND end_date_month IS NULL AND end_date_day IS NULL AND primary_for_locale IS FALSE AND locale IS NULL", name: "search_hints_are_empty"
  end

  create_table "mood_alias_type", id: :serial, force: :cascade do |t|
    t.text "name", null: false
    t.integer "parent"
    t.integer "child_order", default: 0, null: false
    t.text "description"
    t.uuid "gid", null: false
    t.index ["gid"], name: "mood_alias_type_idx_gid", unique: true
  end

  create_table "mood_annotation", primary_key: ["mood", "annotation"], force: :cascade do |t|
    t.integer "mood", null: false
    t.integer "annotation", null: false
  end
  ...
  create_table "place", id: :serial, force: :cascade do |t|
    ...
    t.index "lower(musicbrainz_unaccent((name)::text)), lower(musicbrainz_unaccent((comment)::text))", name: "place_idx_lower_unaccent_name_comment"
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "place_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "place_alias", id: :serial, force: :cascade do |t|
    ...
    t.boolean "primary_for_locale", default: false, null: false
    t.boolean "ended", default: false, null: false
    t.index "lower(musicbrainz_unaccent((name)::text))", name: "place_alias_idx_lower_unaccent_name"
  ...
  create_table "place_meta", id: :integer, default: nil, force: :cascade do |t|
    t.integer "rating", limit: 2
    t.integer "rating_count"
    t.check_constraint "rating >= 0 AND rating <= 100", name: "place_meta_rating_check"
  end

  create_table "place_rating_raw", primary_key: ["place", "editor"], force: :cascade do |t|
    t.integer "place", null: false
    t.integer "editor", null: false
    t.integer "rating", limit: 2, null: false
    t.index ["editor"], name: "place_rating_raw_idx_editor"
    t.check_constraint "rating >= 0 AND rating <= 100", name: "place_rating_raw_rating_check"
  end
  ...
  create_table "recording", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "recording_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "release", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "release_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "release_group", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "release_group_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "release_label", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "catalog_number IS NOT NULL OR label IS NOT NULL", name: "release_label_check"
    t.check_constraint "controlled_for_whitespace(catalog_number::text)", name: "release_label_catalog_number_check"
  end

  create_table "release_meta", id: :integer, default: nil, force: :cascade do |t|
    t.timestamptz "date_added", default: -> { "now()" }
    t.string "info_url", limit: 255
    t.string "amazon_asin", limit: 10
    t.enum "cover_art_presence", default: "absent", null: false, enum_type: "cover_art_presence"
  end
  ...
  create_table "release_raw", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "added", default: -> { "now()" }
    t.timestamptz "last_modified", default: -> { "now()" }
  ...
  create_table "release_unknown_country", primary_key: "release", id: :integer, default: nil, force: :cascade do |t|
    ...
    t.integer "date_month", limit: 2
    t.integer "date_day", limit: 2
    t.check_constraint "date_year IS NOT NULL OR date_month IS NOT NULL OR date_day IS NOT NULL", name: "non_empty_date"
  end
  ...
  create_table "replication_control", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "last_replication_date"
  end
  ...
  create_table "saved_artists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id"], name: "index_saved_artists_on_artist_id"
  ...
  create_table "series", id: :serial, force: :cascade do |t|
    ...
    t.integer "edits_pending", default: 0, null: false
    t.timestamptz "last_updated", default: -> { "now()" }
    t.index "lower(musicbrainz_unaccent((name)::text)), lower(musicbrainz_unaccent((comment)::text))", name: "series_idx_lower_unaccent_name_comment"
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "series_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  create_table "series_alias", id: :serial, force: :cascade do |t|
    ...
    t.boolean "primary_for_locale", default: false, null: false
    t.boolean "ended", default: false, null: false
    t.index "lower(musicbrainz_unaccent((name)::text))", name: "series_alias_idx_lower_unaccent_name"
  ...
  create_table "track", id: :serial, force: :cascade do |t|
    ...
    t.index ["is_canonical"], name: "index_track_on_is_canonical"
    t.index ["recording"], name: "track_idx_recording"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
    t.check_constraint "controlled_for_whitespace(number)", name: "track_number_check"
    ...
    t.check_constraint "name::text <> ''::text", name: "only_non_empty"
    t.unique_constraint ["medium", "position"], deferrable: :immediate, name: "track_uniq_medium_position"
  end
  ...
  create_table "unreferenced_row_log", primary_key: ["table_name", "row_id"], force: :cascade do |t|
    t.string "table_name", null: false
    t.integer "row_id", null: false
    t.timestamptz "inserted", default: -> { "now()" }
    t.index ["inserted"], name: "unreferenced_row_log_idx_inserted", using: :brin
  end
  ...
  create_table "vote", id: :serial, force: :cascade do |t|
    ...
    t.timestamptz "vote_time", default: -> { "now()" }
  ...
  create_table "work", id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "controlled_for_whitespace(comment::text)", name: "work_comment_check"
    t.check_constraint "controlled_for_whitespace(name::text)", name: "control_for_whitespace"
  ...
  add_foreign_key "area_containment", "area", column: "descendant", name: "area_containment_fk_descendant"
  add_foreign_key "area_containment", "area", column: "parent", name: "area_containment_fk_parent"
  ...
  add_foreign_key "artist_credit_gid_redirect", "artist_credit", column: "new_id", name: "artist_credit_gid_redirect_fk_new_id"
  ...
  add_foreign_key "artist_release", "artist", column: "artist", name: "artist_release_fk_artist", on_delete: :cascade
  add_foreign_key "artist_release", "release", column: "release", name: "artist_release_fk_release", on_delete: :cascade
  add_foreign_key "artist_release_group", "artist", column: "artist", name: "artist_release_group_fk_artist", on_delete: :cascade
  add_foreign_key "artist_release_group", "release_group", column: "release_group", name: "artist_release_group_fk_release_group", on_delete: :cascade
  add_foreign_key "artist_release_group_nonva", "artist", column: "artist", name: "artist_release_group_fk_artist", on_delete: :cascade
  add_foreign_key "artist_release_group_nonva", "release_group", column: "release_group", name: "artist_release_group_fk_release_group", on_delete: :cascade
  add_foreign_key "artist_release_group_va", "artist", column: "artist", name: "artist_release_group_fk_artist", on_delete: :cascade
  add_foreign_key "artist_release_group_va", "release_group", column: "release_group", name: "artist_release_group_fk_release_group", on_delete: :cascade
  add_foreign_key "artist_release_nonva", "artist", column: "artist", name: "artist_release_fk_artist", on_delete: :cascade
  add_foreign_key "artist_release_nonva", "release", column: "release", name: "artist_release_fk_release", on_delete: :cascade
  add_foreign_key "artist_release_va", "artist", column: "artist", name: "artist_release_fk_artist", on_delete: :cascade
  add_foreign_key "artist_release_va", "release", column: "release", name: "artist_release_fk_release", on_delete: :cascade
  ...
  add_foreign_key "edit_genre", "edit", column: "edit", name: "edit_genre_fk_edit"
  add_foreign_key "edit_genre", "genre", column: "genre", name: "edit_genre_fk_genre", on_delete: :cascade
  ...
  add_foreign_key "edit_mood", "edit", column: "edit", name: "edit_mood_fk_edit"
  add_foreign_key "edit_mood", "mood", column: "mood", name: "edit_mood_fk_mood", on_delete: :cascade
  ...
  add_foreign_key "edit_note_change", "edit_note", column: "edit_note", name: "edit_note_change_fk_edit_note"
  add_foreign_key "edit_note_change", "editor", column: "change_editor", name: "edit_note_change_fk_change_editor"
  ...
  add_foreign_key "editor_collection_genre", "editor_collection", column: "collection", name: "editor_collection_genre_fk_collection"
  add_foreign_key "editor_collection_genre", "genre", column: "genre", name: "editor_collection_genre_fk_genre"
  add_foreign_key "editor_collection_gid_redirect", "editor_collection", column: "new_id", name: "editor_collection_gid_redirect_fk_new_id"
  ...
  add_foreign_key "genre_alias", "genre_alias_type", column: "type", name: "genre_alias_fk_type"
  add_foreign_key "genre_alias_type", "genre_alias_type", column: "parent", name: "genre_alias_type_fk_parent"
  add_foreign_key "genre_annotation", "annotation", column: "annotation", name: "genre_annotation_fk_annotation"
  add_foreign_key "genre_annotation", "genre", column: "genre", name: "genre_annotation_fk_genre"
  ...
  add_foreign_key "l_area_genre", "area", column: "entity0", name: "l_area_genre_fk_entity0"
  add_foreign_key "l_area_genre", "genre", column: "entity1", name: "l_area_genre_fk_entity1"
  add_foreign_key "l_area_genre", "link", column: "link", name: "l_area_genre_fk_link"
  ...
  add_foreign_key "l_area_mood", "area", column: "entity0", name: "l_area_mood_fk_entity0"
  add_foreign_key "l_area_mood", "link", column: "link", name: "l_area_mood_fk_link"
  add_foreign_key "l_area_mood", "mood", column: "entity1", name: "l_area_mood_fk_entity1"
  ...
  add_foreign_key "l_artist_genre", "artist", column: "entity0", name: "l_artist_genre_fk_entity0"
  add_foreign_key "l_artist_genre", "genre", column: "entity1", name: "l_artist_genre_fk_entity1"
  add_foreign_key "l_artist_genre", "link", column: "link", name: "l_artist_genre_fk_link"
  ...
  add_foreign_key "l_artist_mood", "artist", column: "entity0", name: "l_artist_mood_fk_entity0"
  add_foreign_key "l_artist_mood", "link", column: "link", name: "l_artist_mood_fk_link"
  add_foreign_key "l_artist_mood", "mood", column: "entity1", name: "l_artist_mood_fk_entity1"
  ...
  add_foreign_key "l_event_genre", "event", column: "entity0", name: "l_event_genre_fk_entity0"
  add_foreign_key "l_event_genre", "genre", column: "entity1", name: "l_event_genre_fk_entity1"
  add_foreign_key "l_event_genre", "link", column: "link", name: "l_event_genre_fk_link"
  ...
  add_foreign_key "l_event_mood", "event", column: "entity0", name: "l_event_mood_fk_entity0"
  add_foreign_key "l_event_mood", "link", column: "link", name: "l_event_mood_fk_link"
  add_foreign_key "l_event_mood", "mood", column: "entity1", name: "l_event_mood_fk_entity1"
  ...
  add_foreign_key "l_genre_genre", "genre", column: "entity0", name: "l_genre_genre_fk_entity0"
  add_foreign_key "l_genre_genre", "genre", column: "entity1", name: "l_genre_genre_fk_entity1"
  add_foreign_key "l_genre_genre", "link", column: "link", name: "l_genre_genre_fk_link"
  add_foreign_key "l_genre_instrument", "genre", column: "entity0", name: "l_genre_instrument_fk_entity0"
  add_foreign_key "l_genre_instrument", "instrument", column: "entity1", name: "l_genre_instrument_fk_entity1"
  add_foreign_key "l_genre_instrument", "link", column: "link", name: "l_genre_instrument_fk_link"
  add_foreign_key "l_genre_label", "genre", column: "entity0", name: "l_genre_label_fk_entity0"
  add_foreign_key "l_genre_label", "label", column: "entity1", name: "l_genre_label_fk_entity1"
  add_foreign_key "l_genre_label", "link", column: "link", name: "l_genre_label_fk_link"
  add_foreign_key "l_genre_mood", "genre", column: "entity0", name: "l_genre_mood_fk_entity0"
  add_foreign_key "l_genre_mood", "link", column: "link", name: "l_genre_mood_fk_link"
  add_foreign_key "l_genre_mood", "mood", column: "entity1", name: "l_genre_mood_fk_entity1"
  add_foreign_key "l_genre_place", "genre", column: "entity0", name: "l_genre_place_fk_entity0"
  add_foreign_key "l_genre_place", "link", column: "link", name: "l_genre_place_fk_link"
  add_foreign_key "l_genre_place", "place", column: "entity1", name: "l_genre_place_fk_entity1"
  add_foreign_key "l_genre_recording", "genre", column: "entity0", name: "l_genre_recording_fk_entity0"
  add_foreign_key "l_genre_recording", "link", column: "link", name: "l_genre_recording_fk_link"
  add_foreign_key "l_genre_recording", "recording", column: "entity1", name: "l_genre_recording_fk_entity1"
  add_foreign_key "l_genre_release", "genre", column: "entity0", name: "l_genre_release_fk_entity0"
  add_foreign_key "l_genre_release", "link", column: "link", name: "l_genre_release_fk_link"
  add_foreign_key "l_genre_release", "release", column: "entity1", name: "l_genre_release_fk_entity1"
  add_foreign_key "l_genre_release_group", "genre", column: "entity0", name: "l_genre_release_group_fk_entity0"
  add_foreign_key "l_genre_release_group", "link", column: "link", name: "l_genre_release_group_fk_link"
  add_foreign_key "l_genre_release_group", "release_group", column: "entity1", name: "l_genre_release_group_fk_entity1"
  add_foreign_key "l_genre_series", "genre", column: "entity0", name: "l_genre_series_fk_entity0"
  add_foreign_key "l_genre_series", "link", column: "link", name: "l_genre_series_fk_link"
  add_foreign_key "l_genre_series", "series", column: "entity1", name: "l_genre_series_fk_entity1"
  add_foreign_key "l_genre_url", "genre", column: "entity0", name: "l_genre_url_fk_entity0"
  add_foreign_key "l_genre_url", "link", column: "link", name: "l_genre_url_fk_link"
  add_foreign_key "l_genre_url", "url", column: "entity1", name: "l_genre_url_fk_entity1"
  add_foreign_key "l_genre_work", "genre", column: "entity0", name: "l_genre_work_fk_entity0"
  add_foreign_key "l_genre_work", "link", column: "link", name: "l_genre_work_fk_link"
  add_foreign_key "l_genre_work", "work", column: "entity1", name: "l_genre_work_fk_entity1"
  ...
  add_foreign_key "l_instrument_mood", "instrument", column: "entity0", name: "l_instrument_mood_fk_entity0"
  add_foreign_key "l_instrument_mood", "link", column: "link", name: "l_instrument_mood_fk_link"
  add_foreign_key "l_instrument_mood", "mood", column: "entity1", name: "l_instrument_mood_fk_entity1"
  ...
  add_foreign_key "l_label_mood", "label", column: "entity0", name: "l_label_mood_fk_entity0"
  add_foreign_key "l_label_mood", "link", column: "link", name: "l_label_mood_fk_link"
  add_foreign_key "l_label_mood", "mood", column: "entity1", name: "l_label_mood_fk_entity1"
  ...
  add_foreign_key "l_mood_mood", "link", column: "link", name: "l_mood_mood_fk_link"
  add_foreign_key "l_mood_mood", "mood", column: "entity0", name: "l_mood_mood_fk_entity0"
  add_foreign_key "l_mood_mood", "mood", column: "entity1", name: "l_mood_mood_fk_entity1"
  add_foreign_key "l_mood_place", "link", column: "link", name: "l_mood_place_fk_link"
  add_foreign_key "l_mood_place", "mood", column: "entity0", name: "l_mood_place_fk_entity0"
  add_foreign_key "l_mood_place", "place", column: "entity1", name: "l_mood_place_fk_entity1"
  add_foreign_key "l_mood_recording", "link", column: "link", name: "l_mood_recording_fk_link"
  add_foreign_key "l_mood_recording", "mood", column: "entity0", name: "l_mood_recording_fk_entity0"
  add_foreign_key "l_mood_recording", "recording", column: "entity1", name: "l_mood_recording_fk_entity1"
  add_foreign_key "l_mood_release", "link", column: "link", name: "l_mood_release_fk_link"
  add_foreign_key "l_mood_release", "mood", column: "entity0", name: "l_mood_release_fk_entity0"
  add_foreign_key "l_mood_release", "release", column: "entity1", name: "l_mood_release_fk_entity1"
  add_foreign_key "l_mood_release_group", "link", column: "link", name: "l_mood_release_group_fk_link"
  add_foreign_key "l_mood_release_group", "mood", column: "entity0", name: "l_mood_release_group_fk_entity0"
  add_foreign_key "l_mood_release_group", "release_group", column: "entity1", name: "l_mood_release_group_fk_entity1"
  add_foreign_key "l_mood_series", "link", column: "link", name: "l_mood_series_fk_link"
  add_foreign_key "l_mood_series", "mood", column: "entity0", name: "l_mood_series_fk_entity0"
  add_foreign_key "l_mood_series", "series", column: "entity1", name: "l_mood_series_fk_entity1"
  add_foreign_key "l_mood_url", "link", column: "link", name: "l_mood_url_fk_link"
  add_foreign_key "l_mood_url", "mood", column: "entity0", name: "l_mood_url_fk_entity0"
  add_foreign_key "l_mood_url", "url", column: "entity1", name: "l_mood_url_fk_entity1"
  add_foreign_key "l_mood_work", "link", column: "link", name: "l_mood_work_fk_link"
  add_foreign_key "l_mood_work", "mood", column: "entity0", name: "l_mood_work_fk_entity0"
  add_foreign_key "l_mood_work", "work", column: "entity1", name: "l_mood_work_fk_entity1"
  ...
  add_foreign_key "liked_tracks", "track"
  ...
  add_foreign_key "medium_gid_redirect", "medium", column: "new_id", name: "medium_gid_redirect_fk_new_id"
  add_foreign_key "medium_index", "medium", column: "medium", name: "medium_index_fk_medium", on_delete: :cascade
  add_foreign_key "mood_alias", "mood", column: "mood", name: "mood_alias_fk_mood"
  add_foreign_key "mood_alias", "mood_alias_type", column: "type", name: "mood_alias_fk_type"
  add_foreign_key "mood_alias_type", "mood_alias_type", column: "parent", name: "mood_alias_type_fk_parent"
  add_foreign_key "mood_annotation", "annotation", column: "annotation", name: "mood_annotation_fk_annotation"
  add_foreign_key "mood_annotation", "mood", column: "mood", name: "mood_annotation_fk_mood"
  ...
  add_foreign_key "place_meta", "place", column: "id", name: "place_meta_fk_id", on_delete: :cascade
  add_foreign_key "place_rating_raw", "editor", column: "editor", name: "place_rating_raw_fk_editor"
  add_foreign_key "place_rating_raw", "place", column: "place", name: "place_rating_raw_fk_place"
  ...
  add_foreign_key "saved_artists", "artist"
  add_foreign_key "saved_artists", "users"
  add_foreign_key "saved_releases", "release"
